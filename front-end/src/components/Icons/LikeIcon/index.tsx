...
const LikeIcon: React.FC = () => {
  return (
    <svg
      ...
      width="62"
      height="56"
      viewBox="0 0 64 59.707"
    >
      <g id="Group_5" data-name="Group 5" transform="translate(1 1)">
        <path
          id="Stroke_1"
          data-name="Stroke 1"
          d="M12.516,23.39,2.2,13.062A7.662,7.662,0,0,1,0,7.568,7.436,7.436,0,0,1,7.282,0a7.1,7.1,0,0,1,4.94,2.03L17,6.638l4.779-4.606A7.1,7.1,0,0,1,26.718,0,7.436,7.436,0,0,1,34,7.568a7.735,7.735,0,0,1-2.265,5.564L7.272,37.608,14.664,45"
